...
_self-check 2026-09-25T19:51:40+00:00_

## Do not trade the next board

- selected rows: 7 of 45 settled at +2 against 1.74 expected — P(>=7 | tails correct) = 0.16%, below the 2% halt threshold
...
- 7 of 45 settled at +2 (16%), against 1.74 expected
- P(>= 7 | tails correct) = 0.16%
- 95% CI on the realized rate: 8-29%

## Whole field

- 20 of 493 at >=+2 (4.1%) against 7.5% predicted, t = -2.81

## Does the tail order the outcomes?

| band | range | n | hits | expected |
|---|---|---|---|---|
| low | 2.1-4.7% | 164 | 5 | 6.06 |
| mid | 4.7-8.3% | 164 | 12 | 11.53 |
| high | 8.3-23.2% | 165 | 3 | 19.51 |
...
- field: predicted 7.5% sits above the realized interval [2.6-6.2] — tails may be too conservative
