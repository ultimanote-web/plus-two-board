...
_self-check 2026-09-24T19:49:24+00:00_

## Do not trade the next board

- selected rows: 7 of 43 settled at +2 against 1.67 expected — P(>=7 | tails correct) = 0.13%, below the 2% halt threshold
...
- 7 of 43 settled at +2 (16%), against 1.67 expected
- P(>= 7 | tails correct) = 0.13%
- 95% CI on the realized rate: 8-30%

## Whole field

- 19 of 457 at >=+2 (4.2%) against 7.5% predicted, t = -2.63

## Does the tail order the outcomes?

| band | range | n | hits | expected |
|---|---|---|---|---|
| low | 2.1-4.7% | 152 | 6 | 5.62 |
| mid | 4.7-8.3% | 152 | 10 | 10.72 |
| high | 8.3-23.2% | 153 | 3 | 18.12 |
...
- inputs 15.6 h old, snapshot `d97b44c4b5f2`, 38 stations / 38 tails

## Warnings

- field: predicted 7.5% sits above the realized interval [2.7-6.4] — tails may be too conservative
